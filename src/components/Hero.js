...
const Hero = () => {
  return (
    <div name="home" className="w-full h-screen bg-zinc-200 flex flex-col justify-between">
      <div className="grid grid-cols-1 md:grid-cols-2 max-w-[1240px] mx-auto pt-[80px]">
        ...
        <div className="absolute flex flex-col py-8 md:min-w-[760px] bottom-[2%] mx-1 md:left-1/2 transform md:-translate-x-1/2 bg-zinc-200 border border-slate-300 rounded-xl text-center shadow-xl">
          <p>Data Services</p>
